...
$strLinkPrincipalSelecao = SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_contexto_contato_selecionar&tipo_selecao=2&id_object=objLupaPrincipal');

$strLinkAjaxPrincipal2 = SessaoSEI::getInstance()->assinarLink('controlador_ajax.php?acao_ajax=tipo_contexto_contato_listar');
$strLinkPrincipalSelecao2 = SessaoSEI::getInstance()->assinarLink('controlador.php?acao=tipo_contexto_contato_selecionar&tipo_selecao=2&id_object=objLupaPrincipal2');
?>
