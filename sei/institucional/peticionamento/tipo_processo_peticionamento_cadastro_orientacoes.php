 ...
 require_once dirname(__FILE__).'/../../SEI.php';
  ...
  switch($_GET['acao']){
  	case 'tipo_processo_peticionamento_cadastrar_orientacoes':
		...
		$objTipoProcessoOrientacoesPeticionamentoDTO = new TipoProcessoOrientacoesPeticionamentoDTO();
		$objTipoProcessoOrientacoesPeticionamentoDTO->setStrOrientacoesGerais($_POST['txaConteudo']);  				
		$objTipoProcessoOrientacoesPeticionamentoDTO->setNumIdTipoProcessoOrientacoesPeticionamento(TipoProcessoOrientacoesPeticionamentoRN::$ID_FIXO_TP_PROCESSO_ORIENTACOES);
