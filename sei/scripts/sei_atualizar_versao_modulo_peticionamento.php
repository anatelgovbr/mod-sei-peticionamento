    ...
    <tbody>
        ...
        protected function instalarv300()
        {
            ...
            $sql_tabelas = 'CREATE TABLE md_pet_adm_integracao (
              ...
              endereco_wsdl ' . $objInfraMetaBD->tipoTextoVariavel(100) . ',
              operacao_wsdl ' . $objInfraMetaBD->tipoTextoVariavel(50) . ',
              sin_cache ' . $objInfraMetaBD->tipoTextoFixo(1) . ',
            ...
            if (!BancoSEI::getInstance() instanceof InfraOracle && !BancoSEI::getInstance() instanceof InfraSqlServer) {
            ...
            $this->logar('INSERINDO texto padrão para e-mail exige resposta para pessoa juridica da tabela email_sistema');
...
ATENÇÃO: As informações contidas neste e-mail, incluindo seus anexos, podem ser restritas apenas à pessoa ou entidade para a qual foi endereçada. Se você não é o destinatário ou a pessoa responsável por encaminhar esta mensagem ao destinatário, você está, por meio desta, notificado que não deverá rever, retransmitir, imprimir, copiar, usar ou distribuir esta mensagem ou quaisquer anexos. Caso você tenha recebido esta mensagem por engano, por favor, contate o remetente imediatamente e em seguida apague esta mensagem.";
        ...
        protected function instalarv301()
        {
            ...
            $arrTabelas = array('md_pet_acesso_externo', 'md_pet_criterio', 'md_pet_ext_arquivo_perm', 'md_pet_hipotese_legal', 'md_pet_indisp_doc',
                'md_pet_indisponibilidade', 'md_pet_int_aceite', 'md_pet_int_dest_resposta', 'md_pet_int_prazo_tacita', 'md_pet_int_prot_disponivel',
                'md_pet_int_protocolo', 'md_pet_int_rel_dest', 'md_pet_int_rel_intim_resp', 'md_pet_int_rel_resp_doc', 'md_pet_int_rel_tipo_resp',
                'md_pet_int_rel_tpo_res_des', 'md_pet_int_serie', 'md_pet_int_tipo_intimacao', 'md_pet_int_tipo_resp', 'md_pet_intimacao', 'md_pet_rel_recibo_docanexo',
                'md_pet_rel_recibo_protoc', 'md_pet_rel_tp_ctx_contato', 'md_pet_rel_tp_proc_serie', 'md_pet_rel_tp_processo_unid', 'md_pet_tamanho_arquivo',
                'md_pet_tipo_processo', 'md_pet_tp_processo_orientacoes', 'md_pet_usu_externo_menu');
            ;
...
<p>&nbsp;&nbsp;</p>';
    ...
    ';
            ...
            $this->logar('ATUALIZANDO INFRA_PARAMETRO (' . MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_FORMULARIO . ')');
            $nomeParamIdSerie = MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_FORMULARIO;
...
<p>&nbsp;&nbsp;</p>';
    ...
    ';
            ...
            $this->logar('ATUALIZANDO INFRA_PARAMETRO (' . MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_PROCURACAOE . ')');
            $nomeParamIdSerie = MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_PROCURACAOE;
...
<p>&nbsp;&nbsp;</p>';
    ...
    ';
            ...
            $this->logar('ATUALIZANDO INFRA_PARAMETRO (' . MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_REVOGACAO . ')');
            $nomeParamIdSerie = MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_REVOGACAO;
...
<p>&nbsp;&nbsp;</p>';
    ...
    ';
            ...
            $this->logar('ATUALIZANDO INFRA_PARAMETRO (' . MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_RENUNCIA . ')');
            $nomeParamIdSerie = MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_RENUNCIA;
...
<p>&nbsp;&nbsp;</p>';
    ...
    ';
            ...
            $this->logar('ATUALIZANDO INFRA_PARAMETRO (' . MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_VINC_SUSPENSAO . ')');
            $nomeParamIdSerie = MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_VINC_SUSPENSAO;
...
<p>&nbsp;&nbsp;</p>';
    ...
    ';
            ...
            $this->logar('ATUALIZANDO INFRA_PARAMETRO (' . MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_VINC_RESTABELECIMENTO . ')');
            $nomeParamIdSerie = MdPetAtualizadorSeiRN::$MD_PET_ID_SERIE_VINC_RESTABELECIMENTO;
