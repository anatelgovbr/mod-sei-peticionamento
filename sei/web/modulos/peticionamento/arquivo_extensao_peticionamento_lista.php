...
*
* Versão no CVS: $Id: arquivo_extensao_peticionamento_lista.php 8743 2014-04-23 17:40:44Z mga $
*/
...
try {
  ...
  PaginaSEI::getInstance()->prepararSelecao('arquivo_extensao_peticionamento_selecionar');
  ...
  $arrComandos = array();
  if ($_GET['acao'] == 'arquivo_extensao_peticionamento_selecionar'){
    $arrComandos[] = '<button type="button" accesskey="T" id="btnTransportarSelecao" value="Transportar" onclick="infraTransportarSelecao();" class="infraButton"><span class="infraTeclaAtalho">T</span>ransportar</button>';
  }

  if ($_GET['acao'] == 'arquivo_extensao_listar' || $_GET['acao'] == 'arquivo_extensao_peticionamento_selecionar'){
