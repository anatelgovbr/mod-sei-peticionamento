...
class MdPetVinculoDTO extends InfraDTO
{
    ...
    public function montar()
    {
        ...
        $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'IdTipoProcedimento', 'proc.id_tipo_procedimento', 'procedimento proc');        
        ...
        $this->configurarFK('IdProtocolo', 'procedimento proc', 'proc.id_procedimento');
