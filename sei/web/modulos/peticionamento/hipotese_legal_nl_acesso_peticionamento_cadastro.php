...
#imgLupaHipoteseLgl {position:absolute;left:75.5%;top:27%;}
#imgExcluirHipoteseLgl  {position:absolute;left:75.5%;top:39%;}
#txtHipoteseLgl {position:absolute;left:0%;width:50%;margin-top:1.6%}
#lblHipoteseLgl{}
<?php }else{?>
#selDescricaoHpLegalNvAcesso {width:75%;margin-top:2.6%}
#imgLupaHipoteseLgl {position:absolute;left:75.5%;top:26%;}
#imgExcluirHipoteseLgl  {position:absolute;left:75.5%;top:39%;}
#txtHipoteseLgl {position:absolute;left:0%;width:50%;margin-top:1.6%}
#lblHipoteseLgl{}
<?php } ?>
...
?>
 ...
 <div style="clear: both"></div>
  ...
  <select id="selDescricaoHpLegalNvAcesso" name="selDescricaoHpLegalNvAcesso" size="8" multiple="multiple" class="infraSelect">
   <?=$strItensSelHipLegal?>
  </select>
