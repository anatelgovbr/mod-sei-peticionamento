...
switch($_GET['acao_externa']){
	...
	case 'indisponibilidade_peticionamento_usuario_externo_download':
      	...
      	if( $_POST['hdnIdIndisponibilidadePeticionamento'] != "" ) {
			...
			$objIndisponibilidadePeticionamentoRN = new IndisponibilidadeAnexoPeticionamentoRN();
...
$strLink = $urlBase . '/modulos/peticionamento/indisponibilidade_peticionamento_usuario_externo_lista.php?acao_externa=indisponibilidade_peticionamento_usuario_externo_listar&id_orgao_acesso_externo=0&id_indisponibilidade_peticionamento='.$_GET['id_indisponibilidade_peticionamento'].PaginaSEI::getInstance()->montarAncora($_GET['id_indisponibilidade_peticionamento']);
?>
