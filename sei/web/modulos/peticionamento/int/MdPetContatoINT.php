...
class MdPetContatoINT extends ContatoINT
{
    ...
    public function getDadosContatos($idContato, $idDocumento, $xml = true)
    {
        ...
        public
        function getContatosNomeAutoCompleteJuridico($strPalavrasPesquisa)
        {
        ...
        public
        function getDadosContatosJuridico($idContato, $idDocumento, $xml = true)
        {
        ...
        public
        function getDadosContatosJuridicoRecuperar($idContato, $idDocumento, $xml = true)
        {
