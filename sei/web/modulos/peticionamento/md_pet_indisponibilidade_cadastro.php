...
try {
  ...
  if( $_GET['acao'] != "md_pet_indisponibilidade_download"){
    PaginaSEI::getInstance()->verificarSelecao('md_pet_indisponibilidade_alterar');
  }
  ...
  switch($_GET['acao']){
    ...
    case 'md_pet_indisponibilidade_cadastrar':
      ...
      $strLinkAnexos = SessaoSEI::getInstance()->assinarLink('controlador.php?acao=md_pet_indisponibilidade_upload_anexo');
      ...
      $objMdPetIndisponibilidadeDTO->setArrObjAnexoDTO(MdPetIndisponibilidadeAnexoINT::processarAnexo($_POST['hdnAnexos']));
    ...
    case 'md_pet_indisponibilidade_alterar':
      ...
      if (isset($_POST['sbmAlterarIndisponibilidadePeticionamento'])) {
      	...
      	try{
        	...
        	$objMdPetIndisponibilidadeDTO = new MdPetIndisponibilidadeDTO();
        	$objMdPetIndisponibilidadeDTO->setNumIdIndisponibilidade($_POST['hdnIdIndisponibilidadePeticionamento']);
        	...
        	if( $_POST['hdnAnexos'] != $_POST['hdnAnexosInicial']) {
        	  $anexoDTO = new MdPetIndisponibilidadeAnexoDTO();
        	  $anexoDTO->setNumIdIndisponibilidade( $objMdPetIndisponibilidadeDTO->getNumIdIndisponibilidade() );
        	  $anexoDTO->retTodos();
        	  $rnAnexo = new MdPetIndisponibilidadeAnexoRN();
        	...
        	$objMdPetIndisponibilidadeRN = new MdPetIndisponibilidadeRN();
        	$objMdPetIndisponibilidadeRN->alterar($objMdPetIndisponibilidadeDTO);
      ...
      case 'md_pet_indisponibilidade_download':
      	...
      	if( $_POST['hdnIdIndisponibilidadePeticionamento'] != "" ) {
      	  ...
      	  $objMdPetIndisponibilidadeAnexoRN = new MdPetIndisponibilidadeAnexoRN(); //hdnIdIndisponibilidadePeticionamento
    ...
    case 'md_pet_indisponibilidade_consultar':
      ...
      //$dateStr = date_create( $objMdPetIndisponibilidadeDTO->getDthDataInicio() );
...
if (isset($_GET['id_indisponibilidade_peticionamento'])){
	...
	if ($_GET ['acao'] != 'md_pet_indisponibilidade_consultar')	{
		$_POST ['hdnAnexos'] = MdPetIndisponibilidadeAnexoINT::montarAnexosIndisponibilidade ( $objMdPetIndisponibilidadeDTO->getNumIdIndisponibilidade (), false, $arrAcoesDownload, true, $arrAcoesRemover );
		//echo $_POST ['hdnAnexos']; die();
	} 
	else {
		$_POST ['hdnAnexos'] = MdPetIndisponibilidadeAnexoINT::montarAnexosIndisponibilidade ( $objMdPetIndisponibilidadeDTO->getNumIdIndisponibilidade (), false, $arrAcoesDownload, false, $arrAcoesRemover );
	}
...
?>
 ...
 <!--  Data Inicio  -->
    ...
    <input type="text" onchange="validDate('I')" onkeypress="return infraMascara(this, event, '##/##/#### ##:##');" name="txtDtInicio" id="txtDtInicio" value="<?= $objMdPetIndisponibilidadeDTO->getDthDataInicioFormatada() ?>" class="infraText" />
  ...
  <!--  Data Fim  -->
    ...
    <input type="text" onchange="validDate('F')" onkeypress="return infraMascara(this, event, '##/##/#### ##:##');" name="txtDtFim" id="txtDtFim" value="<?= $objMdPetIndisponibilidadeDTO->getDthDataFimFormatada() ?>" class="infraText"/>
    ...
    <textarea type="text" id="txtResumoIndisponibilidade" rows="3" name="txtResumoIndisponibilidade" class="infraText" onkeypress="return infraMascaraTexto(this,event,250);" maxlength="250" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?php echo isset($objMdPetIndisponibilidadeDTO) ? $objMdPetIndisponibilidadeDTO->getStrResumoIndisponibilidade() : '' ?></textarea>
    </fieldset>
   ...
   <input <?php echo isset($objMdPetIndisponibilidadeDTO) && ($objMdPetIndisponibilidadeDTO->getStrSinProrrogacao() && $objMdPetIndisponibilidadeDTO->getStrSinProrrogacao() == 'S') ? 'checked="checked"' : ''  ?> type="radio" id="rdProrrogacaoSim" name="rdProrrogacao[]" /> <label id="lblProrrogacaoSim" class="infraLabelCheckbox" for="rdProrrogacaoSim">Sim</label>
   </div>
   <div id="divProrrogacaoNao" style="margin-top:0.2%">
   <input <?php echo isset($objMdPetIndisponibilidadeDTO) && ($objMdPetIndisponibilidadeDTO->getStrSinProrrogacao() && $objMdPetIndisponibilidadeDTO->getStrSinProrrogacao() == 'N') ? 'checked="checked"' : ''  ?> type="radio" id="rdProrrogacaoNao" name="rdProrrogacao[]" /> <label id="lblProrrogacaoNao" class="infraLabelCheckbox" for="rdProrrogacaoNao">Não</label>
   </div>
...
function inicializar(){
  ...
  var urlBase = "<?=PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?download=1&acao=md_pet_indisponibilidade_download'))?>";
  ...
  <? if (count($arrAcoesRemover)>0 || $_POST['hdnAnexos'] != ""  ){
        ...
        $urlBase = PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?download=1&acao=md_pet_indisponibilidade_download'));
  ...
  ?>
		...
		<?php if( $_GET['acao'] == 'md_pet_indisponibilidade_consultar' ){ ?>
