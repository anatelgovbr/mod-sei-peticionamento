...
if ($numRegistros > 0) {
    ...
    //Tipo Destinatario
    $strResultado .= '<th class="infraTh" width="500px;">' .PaginaSEI::getInstance()->getThOrdenacao($objConsultaDTO, 'Destinatário', 'NomeContato', $arrObjResultDTO). '</th>';
    ...
    //Situação
    $strResultado .= '<th class="infraTh" width="400px">' .PaginaSEI::getInstance()->getThOrdenacao($objConsultaDTO, 'Situação da Intimação', 'SituacaoIntimacao', $arrObjResultDTO).' </th>';
	
	//Número SEI da Certidão de Cumprimento
	$strResultado .= '<th class="infraTh" >' .PaginaSEI::getInstance()->getThOrdenacao($objConsultaDTO, 'Número SEI Certidão de Cumprimento', 'IdMdPetAceite', $arrObjResultDTO). '</th>';
    ...
    for ($i = 0; $i < $numRegistros; $i++) {
	    ...
	    //Número SEI  Certidão de Cumprimento
	    $strResultado .= '<td align="center">';
