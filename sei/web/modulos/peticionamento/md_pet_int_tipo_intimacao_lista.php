...
try {
    ...
    if ($numRegistros != 0) {
        ...
        $strResultado .= '<th class="infraTh" align="left" style="text-align: left" width="250">' . PaginaSEI::getInstance()->getThOrdenacao($objMdPetIntTipoIntimacaoDTO, 'Tipo de Intimação Eletrônica', 'Nome', $arrObjMdPetIntTipoIntimacaoDTO) . '</th>' . "\n";
