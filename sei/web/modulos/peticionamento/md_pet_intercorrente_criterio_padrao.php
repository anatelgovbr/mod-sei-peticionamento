                        ...
                        <div class="row" id="divNivelAcesso" <?php echo $sinNAPadrao != '' ? 'style="display: flex;"' : 'style="display: none;"' ?>>
                            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                <div class="form-group mb-0">
                                    ...
                                    <select id="selNivelAcesso" name="selNivelAcesso" onchange="changeSelectNivelAcesso()" class="infraSelect form-select">
                                        <?= $strItensSelNivelAcesso ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9" id="divHipoteseLegal" <?php echo $hipoteseLegal ?>>
                                <div class="form-group">
                                    ...
                                    <select id="selHipoteseLegal" name="selHipoteseLegal" class="infraSelect form-select" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>">
                                        <?= $strItensSelHipoteseLegal ?>
                                    </select>
                                </div>
                            </div>
