...
<fieldset id="field_documentos" class="infraFieldset sizeFieldset form-control" style="display: none; height: auto">
    ...
    <div class="p-3 mb-2 subFieldset">
                ...
                <div class="form-group">
                    <div id="divTipoConferencia" style="display: none">
                        ...
                        <div class="input-group">
                            <select id="selTipoConferencia" name="selTipoConferencia" class="infraSelect form-select" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() + 2; ?>">
        ...
        <div class="row mt-3">
            <div class="col-12 infraAreaDados" id="divArquivo" style="height: 95px">
                <div class="form-group mb-4">
                    <label class="infraLabelObrigatorio" for="fileArquivo">
                        Tamanho máximo do arquivo: <?= is_int($tamanhoMaximo) ? $tamanhoMaximo . 'Mb' : $tamanhoMaximo; ?><br/>
            ...
            <div class="col-12">
                <div id="divTipoConferenciaBotao">
                    <input type="button" class="infraButton mt-2" value="Adicionar" onclick="adicionarDocumento()" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() + 2; ?>">
                </div>
            </div>
        </div>
        <div class="row mt-3">
