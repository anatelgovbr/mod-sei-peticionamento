...
<script type="text/javascript">
    ...
    function inicializar() {
        ...
        objAjaxCidade.prepararExecucao = function () {
            var itemCidadeSelecionado = '<?= isset($_POST['selCidade']) ? $_POST['selCidade'] : null; ?>';
            return infraAjaxMontarPostPadraoSelect('null', '', itemCidadeSelecionado) + '&idUf=' + document.getElementById('selEstado').value;
        }
        <?php if(isset($_POST['selCidade'])): ?>
        ...
        objAjaxCargo.prepararExecucao = function () {
            ...
            echo "console.log(" . $_POST['cargo'] . ");";
            echo "return infraAjaxMontarPostPadraoSelect('null','','" . $_POST['cargo'] . "') + '&staGenero=' + genero;";
        } else {
        ...
        if (document.getElementById('optFeminino').checked) {
            document.getElementById('optMasculino').click();
            document.getElementById('optFeminino').click();
        } else if (document.getElementById('optMasculino').checked) {
