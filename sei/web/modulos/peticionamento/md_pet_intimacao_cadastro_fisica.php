            ...
            <legend class="infraLegend" class="infraLabelObrigatorio"> Destinatários</legend>
                ...
                <div class="grid_12">
                    <div class="grid grid_5-0">                    
                        ...
                        <img style="margin-bottom:-3px;" src="<?= PaginaSEI::getInstance()->getDiretorioImagensGlobal() ?>/ajuda.gif" name="ajuda" id="imgAjudaUsuario" <?= PaginaSEI::montarTitleTooltip('A pesquisa é realizada somente sobre Usuários Externos liberados. \n \n A pesquisa pode ser efetuada pelo Nome, E-mail ou CPF do Usuário Externo.') ?> class="infraImg"/><br>
                        ...
                        src="/infra_css/imagens/lupa.gif" alt="Selecionar Usuário Externo"
                ...
                <div id="divTabelaUsuarioExterno" class="tabUsuario infraAreaTabela" style="<?php echo $_REQUEST['is_alterar'] ? '' : 'display:none' ?>">
                    <table id="tblEnderecosEletronicos" width="100%" summary="Lista de Pessoas Jurídicas disponíveis" class="infraTable">
                        ...
                        <tr>
                            ...
                            <th class="infraTh" width="66px">Data de Expedição</th>
                            <th class="infraTh" width="130px">Situação da Intimação</th>
