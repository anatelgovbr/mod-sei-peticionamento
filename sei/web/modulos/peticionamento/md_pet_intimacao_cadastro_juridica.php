            ...
            <legend class="infraLegend" class="infraLabelObrigatorio"> Destinatários</legend>
                ...
                <div class="grid_12">
                    <div class="grid grid_5-0">
                        ...
                        <img style="margin-bottom:-3px;" src="<?= PaginaSEI::getInstance()->getDiretorioImagensGlobal() ?>/ajuda.gif" name="ajuda" id="imgAjudaUsuario" <?= PaginaSEI::montarTitleTooltip('A pesquisa é realizada somente sobre Pessoas Jurídicas que já tenham vinculado pelo menos o Responsável Legal no âmbito do Acesso Externo do SEI. \n \n A consulta pode ser efetuada pela Razão Social ou CNPJ da Pessoa Jurídica.') ?> class="infraImg"/><br>
                        ...
                        src="/infra_css/imagens/lupa.gif" alt="Selecionar Pessoa Jurídica"
...
<!--
                ...
                <div id="hiddeTable">
                    ...
                    <caption id="test"
                                class="infraCaption"><?= PaginaSEI::getInstance()->gerarCaptionTabela("Pessoas Jurídicas disponiveis", count($arrIntimacoes)) ?></caption>
                        <tr>
                        <th style="display:none;">ID</th>
                            <th class="infraTh">Razão Social</th>
                            <th class="infraTh" width="125px">CNPJ</th>
                            <th class="infraTh" width="80px">Data de Expedição</th>
                            <th class="infraTh" width="215px">Situação da Intimação</th>
                            <th class="infraTh" width="40px" >Ações</th>
                        </tr>
                            ...
                            <? foreach ($arrIntimacoes as $key => $intimacao) {
                                ...
                                <td style="display:none; width: 100px;  "> <?= $intimacao['Id'] ?></td>
                                    ...
                                    <td align="center" ><a  href='#'
                                            ...
                                            <img title='Consultar Intimação Eletrônica' alt='Consultar Intimação Eletrônica'
        ...
        <fieldset id="fldDocumentosIntimacao">
            ...
            <div class="grid grid_10">
                <label id="lblAnexosIntimacao" for="lblAnexosIntimacao" accesskey="" class="infraLabelObrigatorio">Protocolos dos Anexos da Intimação:</label>
