    ...
    <form id="frmPeticionarProcesso"
        ...
        <div id="procuracaoSimplesFieldSet" class="rowFieldSet">
            <fieldset id="fldResposta"class="infraFieldset form-control fieldset-comum">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5 col-lg-4 col-xl-3 mb-2">
                ...
                <div class="row pt-0">
                    <div class="col-8 col-sm-8 col-md-7 col-lg-7 col-xl-5">
                        <div class="form-group">
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-2" id="dvDataLimite" style="display:none;">
                        <div class="form-group">
