...
?>
    <form id="frmPeticionarProcesso"
            ...
            <div class="col-sm-12 col-md-8 col-lg-6 col-xl-4">
                <div id="hiddenOutorgante" style="display:none;">
                    ...
                    <input type="radio" onchange="showPessoaOutorganteHidden();" name="Outorgante"
                           id="rbOutorgante1" class="infraRadio"
                           <?php echo $bloqueioRadioPF ? "disabled='disabled' style='display:none'" : ""; ?>checked="checked"
                           value="PF">
                    ...
                    <input type="radio" onchange="showPessoaOutorgante();" name="Outorgante"
                           id="rbOutorgante2" class="infraRadio" value="PJ">
                    <label for="rbOutorgante2" id="lvbJuridica" class="infraLabelRadio">
                        Pessoa Jurídica
                    </label>
                    <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                         name="ajuda"
                        <?= PaginaSEI::montarTitleTooltip('Ao selecionar a opção Pessoa Jurídica, a Procuração Eletrônica terá como objetivo definir alguém para representar a Pessoa Jurídica que você já representa como Responsável Legal ou como Procurador Especial.', 'Ajuda') ?>
                         class="infraImgModulo" id="ajudaPJ"/>
                </div>
                <!-- Procuracao Simples -->
        ...
        <div id="procuracaoSimplesFieldSet">
            <fieldset id="fldResposta" style="height:100%;">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div id="listaPoderes">
                            <select onchange="" id="selTpPoder" name="selTpPoder[]"
                                    class="infraSelect multipleSelect">
                                <?php
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-lg-5 col-xl-4">
                        ...
                        <input type="radio" onchange="showDataNot();" name="Validade"
                               id="rbValidade" class="infraRadio"
                               value="1">
                        ...
                        <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                            ...
                            <?= PaginaSEI::montarTitleTooltip('Ao selecionar esta opção, o Procurador representará o Outorgante por prazo indeterminado. \n \n Contudo, a qualquer momento o Outorgante poderá Revogar a Procuração ou o próprio Outorgado poderá Renunciar a Procuração.', 'Ajuda') ?>
                             class="infraImgModulo"/>
                        <input type="radio" onchange="showData();" class="infraRadio" name="Validade" id="rbValidade2"
                               value="2"">
                ...
                <div id="procDados" style="display:none;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-10 col-lg-10 col-xl-10">
                            ...
                            <table width="99%" class="infraTable" summary="Processos" id="tbProcessos"
                                   style="display:none;">
                                <caption class="infraCaption">&nbsp;</caption>
                                <tr>
                                    <th class="infraTh" width="0" style="display:none;">ID</th>
            ...
            <input type="hidden" name=hdnCpfContExterno" id="hdnCpfContExterno"
                   value="<?= InfraUtil::formatarCpf($cpfContato) ?>"/>
