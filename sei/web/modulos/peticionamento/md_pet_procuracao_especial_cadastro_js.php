...
<script type="text/javascript">
            ...
            success: function (data) {
                ...
                //Validando para ver se o usuário externo não é pendente
                            $.ajax({
                                    ...
                                    data: {
                                        'idContato': document.getElementById('hdnIdUsuario').value, 'hdnIdContExterno': document.getElementById('hdnIdUsuario').value 
                                    },
                                    success: function (data) {
    ...
    function validarCampos()
    {
        ...
        if((infraFormatarCpf(document.getElementById('hdnCpf').value) == document.getElementById('hdnCpfContExterno').value) && (document.getElementById('hdnIdContExterno').value == document.getElementById('hdnIdUsuarioProcuracao').value ) ){
            alert("Não é permitida a geração de Procuração Eletrônica para você mesmo. \n Informe o CPF da Pessoa Física que irá te representar.")
            return false;
        }
        ...
        //Procuração Simples
        //Validação de Modal
        var dados = {idOutorgado:document.getElementById('hdnIdContExterno').value,tipoProc:document.getElementById('selTipoProcuracao').value};
        ...
        if(document.getElementById('hdnRbOutorgante').value == "PF"){
            ...
            var dados = {idOutorgante:document.getElementById('hdnIdContExterno').value,idOutorgado:document.getElementById('hdnIdUsuario').value,tipoProc:document.getElementById('selTipoProcuracao').value,poderes:document.getElementById('hdnTpPoderes').value,validade:validadeValor,processos:document.getElementById('hdnTbProcessos').value};
            ...
            var dados = {idOutorgante:document.getElementById('selPessoaJuridicaProcSimples').value,idOutorgado:document.getElementById('hdnIdUsuario').value,tipoProc:document.getElementById('selTipoProcuracao').value,poderes:document.getElementById('hdnTpPoderes').value,validade:validadeValor,processos:document.getElementById('hdnTbProcessos').value};
        }
        ...
        //Validação de Modal
        var dados = {idOutorgado:document.getElementById('hdnIdContExterno').value,tipoProc:document.getElementById('selTipoProcuracao').value,idOutorgante:document.getElementById('selPessoaJuridica').value};
        $.ajax({
             dataType: 'xml',
             method: 'POST',
             url: '<?php echo $strLinkAjaxValidarExistenciaProc?>',
    ...
    textoProcEsp += '<div class="margemConteudo">';
    textoProcEsp += '4. Substabelecer os poderes outorgados pela presente Procuração, ao conceder Procurações Eletrônicas ';
    ...
    var textoProcSimp = '<div class="espacamentoConteudo">';
        textoProcSimp +='A Procuração Eletrônica concede, no âmbito do(a) <?=$siglaOrgao?>, ao Usuário Externo, os Poderes expressamente estabelecidos e em conformidade com a Validade e Abrangência definidos.';
        textoProcSimp +='</div>';

        textoProcSimp +='<div class="espacamentoConteudo">';
        textoProcSimp +='Ao conceder a Procuração Eletrônica, você se declara ciente de que:';
        textoProcSimp +='</div>';

        textoProcSimp +='<div class="margemConteudo">';
        textoProcSimp +='&bullet; '
        textoProcSimp +='Poderá, a qualquer tempo, por meio do SEI-<?=$siglaOrgao?>, revogar a Procuração Eletrônica;';
        textoProcSimp +='</div>';

        textoProcSimp +='<div class="margemConteudo">';
        textoProcSimp +='&bullet; '
        textoProcSimp +='O Outorgado poderá, a qualquer tempo, por meio do SEI-<?=$siglaOrgao?>, renunciar a Procuração Eletrônica;';
        textoProcSimp +='</div>';
         ...
         $.ajax({
             ...
             success: function (data) {
                ...
                var ids = [];
                         ...
                         //Inseindo Usuário Externo na Combo
         ...
         $.ajax({
             ...
             success: function (data) {
                ...
                var cpf = "";
                         ...
                         document.getElementById('hdnCpf').value = cpf;
