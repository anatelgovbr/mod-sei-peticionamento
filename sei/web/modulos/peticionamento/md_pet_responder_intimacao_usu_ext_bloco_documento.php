                ...
                <div class="form-group mt-3 mb-2">
                    <div class="form-group">
                        <label class="infraLabelObrigatorio" for="fileArquivo">
                            Tamanho máximo no arquivo: <?= is_int($tamanhoMaximo) ? $tamanhoMaximo . 'Mb' : $tamanhoMaximo; ?><br/>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="table-responsive">
                    <table width="100%" class="infraTable" summary="Documento" id="tbDocumento" style="display: none">
