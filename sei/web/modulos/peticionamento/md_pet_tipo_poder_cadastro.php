...
?>
<label id="lblNome" for="txtNome" class="infraLabelObrigatorio" style="line-height:12px;">Nome: <img align="top" style="height:16px; width:16px;" src="<?= PaginaSEI::getInstance()->getDiretorioImagensGlobal() ?>/ajuda.gif" name="ajuda" <?= PaginaSEI::montarTitleTooltip('Indicar Poderes específicos para serem utilizados na emissão de Procuração Eletrônica simples pelos Usuários Externos. \n \n Por exemplo: Participar em Reuniões, Peticionar Processo Novo ou Intercorrente, Operar Sistemas.')?> class="infraImg"/></label><br>
