    ...
    <div id="divUnidade">
        <fieldset class="infraFieldset" style="width:75%;">
            ...
            <div id="divCpUnidadeUnica" <?php echo $divUnidadeUnica; ?>>
                ...
                <img id="imgExcluirUnidade" onclick="objLupaUnidade.remover();removerIconeRestricao();" src="/infra_css/imagens/remover.gif" alt="Remover Unidade" title="Remover Unidade" class="infraImg" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div id="divCpUnidadeMultipla" <?php echo $divUnidadeMultipla; ?>>
                ...
                <div id="divOrgaoUnidadeMultipla" class="infraAreaDados" style="height:5em;">
                    ...
                    <div id="divOpcoesOrgaos">
                        <img id="imgLupaOrgaos" onclick="objLupaOrgaoUnidadeMultipla.selecionar(700, 500);" src="<?= PaginaSEI::getInstance()->getDiretorioImagensGlobal(); ?>/lupa.gif" alt="Selecionar Órgão" title="Selecionar Órgão" class="infraImgNormal"  />
                    </div>
                    ...
                    <div id="divOpcoesUnidades">
                        <img id="imgLupaUnidadeMultipla" onclick="verificarOrgaoSelecionado();" src="<?= PaginaSEI::getInstance()->getDiretorioImagensGlobal(); ?>/lupa.gif" alt="Selecionar Unidade" title="Selecionar Unidade" class="infraImg"  />
                    </div>
