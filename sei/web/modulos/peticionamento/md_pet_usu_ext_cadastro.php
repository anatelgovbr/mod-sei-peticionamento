...
<div class="infraAreaGlobal">
    ...
    <fieldset id="formularioPeticionamento" class="infraFieldset sizeFieldset form-control">
        ...
        <? if ($arrUnidadeUFDTO != null && count($arrUnidadeUFDTO) > 1) { ?>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    <label id="lblPublico" style="<?php echo $hiddenOrgao; ?>" class="infraLabelObrigatorio">
                        ...
                        <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                             name="ajuda" <?= PaginaSEI::montarTitleTooltip("Neste campo somente são listados os Órgãos em que é possível abrir Processo Novo para o Tipo de Processo selecionado. \n \n Selecione abaixo o Órgão no qual deseja que este Processo seja aberto. ", 'Ajuda') ?>
                             alt="Ajuda" class="infraImgModulo"/></label> <br/>
                    <select onchange="pesquisarUF(this)" style="<?php echo $hiddenOrgao; ?>" id="selOrgao"
                            name="selOrgao" class="infraSelect form-control">
                        <?php if ($orgaoDuplo) { ?>
                            <?php if (empty($oragao)) { ?>
                                <option value=""></option>
                            <?php } ?>
            ...
            <div class="row" style="<?php echo $hiddUF; ?>" id="ufHidden">
                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
                    <!-- UF -->
                    <label id="lblPublico" class="infraLabelObrigatorio">UF: <img
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                name="ajuda" <?= PaginaSEI::montarTitleTooltip("Neste campo somente são listadas as UFs em que é possível abrir Processo Novo para o Tipo de Processo selecionado. \n \n Selecione abaixo a UF na qual deseja que este Processo seja aberto. ", 'Ajuda') ?>
                                alt="Ajuda" class="infraImgModulo"/></label> <br/>
            ...
            <div class="row" style="<?php echo $cidadeHidde; ?>" id="cidadeHidden">
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    <!-- Cidade -->
                    <label id="lblPublico" class="infraLabelObrigatorio">Cidade: <img
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                name="ajuda" <?= PaginaSEI::montarTitleTooltip("Neste campo somente são listadas as Cidades em que é possível abrir Processo Novo para o Tipo de Processo selecionado. \n \n Selecione abaixo a Cidade na qual deseja que este Processo seja aberto.", 'Ajuda') ?>
                                alt="Ajuda" class="infraImgModulo"/></label> <br/>
                    <select onchange="pesquisarFinal(this)" style="width:271px;" id="selUFAberturaProcesso"
                            name="selUFAberturaProcesso" class="infraSelect form-control">
                        <?php
                        $qtdSelectCidade = isset($selectCidade[0]) ? count($selectCidade[0]) : 0;
                        if ($qtdSelectCidade > 1) {
                            ?>
            ...
            <input type="hidden" name="hdnIdUfTelaAnterior" id="hdnIdUfTelaAnterior"
                   value="<?php echo $_GET['id_uf'] ?>"/>
            <input type="hidden" name="hdnIdCidadeTelaAnterior" id="hdnIdCidadeTelaAnterior"
                   value="<?php echo $cidadeHidden; ?>"/>
            <input type="hidden" name="hdnIdOrgaoTelaAnterior" id="hdnIdOrgaoTelaAnterior"
                   value="<?php echo $_GET['id_orgao'] ?>"/>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <? if ($objTipoProcDTO->getStrSinIIProprioUsuarioExterno() == 'S') { ?>
                    ...
                    <div id="divOptPublico" class="infraDivRadio">
		                <span id="spnPublico0">
			                <label id="lblPublico" class="infraLabelObrigatorio">Interessado: <img
                                        src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                        name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipInteressadoProprioUsuarioExterno, 'Ajuda') ?> alt="Ajuda"
                ...
                <? } else if ($objTipoProcDTO->getStrSinIIIndicacaoDiretaCpfCnpj() == 'S') { ?>
                    ...
                    <label id="lblPublico" class="infraLabelObrigatorio">Interessados: <img
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipInteressadoInformandoCPFeCNPJ, 'Ajuda') ?>
                                alt="Ajuda"
                                class="infraImgModulo"/>
                    </label>
                    <br/>
                    <input name="rdoTipoPessoa" id="optTipoPessoaFisica" onclick="selecionarPF()"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-lx-4" id="divSel1" style="display: none;">
                            <label id="descTipoPessoa" class="infraLabelObrigatorio"> </label>
                            <div class="input-group mb-3 divClean">
                                <input type="text" id="txtCPF" class="infraText form-control" name="txtCPF"
                                       onkeyup="return alterandoCPF(this, event)" style="display:none;"
                                       maxlength="14"/>

                                <input type="text" id="txtCNPJ" class="infraText form-control" name="txtCNPJ"
                                       onkeyup="return alterandoCNPJ(this, event)" style="display:none;"
                                       maxlength="18"/>

                                <input type="button" id="btValidarCPFCNPJ" class="infraText" value="Validar"
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-lx-4" id="divSel2" style="display: none;">
                            <label id="descNomePessoa" class="infraLabelObrigatorio"> </label>
                            <div class="input-group mb-3 divClean">
                                <input type="text" class="infraText form-control" name="txtNomeRazaoSocial"
                                       id="txtNomeRazaoSocial"
                                       readonly="readonly"
                                       style="display: none;" disabled>

                                <input type="button" id="btAdicionarInteressado" class="infraText" value="Adicionar"
                                       style="display: none;" onclick="adicionarInteressadoValido()"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-lx-12" id="divSel0">
                            <table id="tbInteressadosIndicados" class="infraTable" width="98%" align="left"
                                ...
                                <tr>
                                    ...
                                    <th class="infraTh" width="10%" id="tdDescTipoPessoaSelecao"> Tipo</th>
                ...
                <? } else if ($objTipoProcDTO->getStrSinIIIndicacaoDiretaContato() == 'S') {
                    ...
                    <div id="divOptPublico" class="infraDivRadio">
                        <span id="spnPublico0">
                            <label id="lblPublico" class="infraLabelObrigatorio">Interessados: <img
                                        src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                        name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipInteressadoDigitadoNomeExistente, 'Ajuda') ?> alt="Ajuda"
                                        class="infraImg"/></label>
		                </span>
                    </div>
                    ...
                    <input type="text" name="txtInteressado" id="txtInteressado" maxlength="250" value=""
                           style="width: 50%"
                           class="infraText" autocomplete="off"/> <br/>

                    <div style="margin-top: 5px;">

                        <select style="float: left; width: 75%; margin-right: 5px;" id="selInteressados"
                                name="selInteressados"
                        ...
                        <img id="imgLupaTipoDocumento" onclick="carregarComponenteLupaInteressados('S');"
                             src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/consultar.svg"
                             alt="Localizar Interessados" title="Localizar Interessados"
                             class="infraImg">
                        <img id="imgExcluirTipoDocumento" onclick="carregarComponenteLupaInteressados('R');"
                             src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/remover.svg"
                             alt="Remover Interessados" title="Remover Interessados"
                             class="infraImg">
                        <br/>
...
<input type="hidden" id="id_tipo_procedimento" name="id_tipo_procedimento"
