...
<form method="post" id="frmDocumentoPrincipal" enctype="multipart/form-data" action="<?= $strLinkUploadDocPrincipal ?>">
    ...
    <input type="hidden" id="hdnDocPrincipalInicial" name="hdnDocPrincipalInicial"
           value="<?= $_POST['hdnDocPrincipalInicial'] ?>"/>

    <fieldset id="field3" class="infraFieldset sizeFieldset form-control">
        <legend class="infraLegend">&nbsp; Documentos &nbsp;</legend>
        <br/>
        <label>Os documentos devem ser carregados abaixo, sendo de sua exclusiva responsabilidade a conformidade entre
        ...
        <? if ($externo == 'S') { ?>
            ...
            <div style="float: left; height: 42px; margin-right: 10px;">
                <label id="lblPublico" class="infraLabelObrigatorio">Tipo de Documento: <img
                            ...
                            name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipTipoDocumentoPrincipal, 'Ajuda') ?>
            ...
            <div style="float: left; height: 42px;">
                <label id="lblPublico" class="infraLabelObrigatorio">Complemento do Tipo de Documento: <img
                            src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                            name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipComplementoTipoDocumento, 'Ajuda') ?>
                            alt="Ajuda" class="infraImg"/></label>
                <br/>
                <input type="text" class="infraText" name="complementoPrincipal" id="complementoPrincipal"
        ...
        <div style="float: left; width: 90%;">
            <div class="input-group mb-3">
                <label class="infraLabelObrigatorio" style="margin-top: 10px">Documento Principal: </label> &nbsp;&nbsp;
        ...
        <div style="float: left;">
            <? if ($isUsuarioExternoPodeIndicarNivelAcesso == 'S') { ?>
                <label id="lblPublico" class="infraLabelObrigatorio">Nível de Acesso: <img
                            src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                            name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipNivelAcesso, 'Ajuda') ?>
                            alt="Ajuda" class="infraImg"/></label> <br/>
                <select class="infraSelect" id="nivelAcesso1" name="nivelAcesso1"
            ...
            <? } else if ($isNivelAcessoPadrao == 'S') { ?>
                <label id="lblPublico" class="infraLabelObrigatorio">Nível de Acesso: <img
                            src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                            name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipNivelAcessoPadraoPreDefinido, 'Ajuda') ?>
                            alt="Ajuda" class="infraImg"/></label> <br/>
        ...
        <div id="divhipoteseLegal1" style="float: left; width: 70%; display:block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div id="divhipoteseLegal1" style="float: left; width: 70%; display:none;">
                ...
                <? if ($isConfigHipoteseLegal && $isNivelAcessoPadrao != 'S') { ?>
                    ...
                    <label id="lblPublico" class="infraLabelObrigatorio">Hipótese Legal: <img
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipHipoteseLegal, 'Ajuda') ?>
                                alt="Ajuda" class="infraImg"/></label> <br/>
                    <select class="infraSelect" id="hipoteseLegal1" name="hipoteseLegal1"
                            style="width: 95%; float: left; margin-right: 5px;">
                        <option value=""></option>
                        <?
                ...
                <? if ($externo == 'S') { ?>
                    <input type="button" class="infraButton" value="Adicionar" name="btAddDocumentos"
                           onclick="validarUploadArquivo('1')"/>
                <? } ?>
            ...
            <div id="divhipoteseLegal1" style="float: left; width: 70%; display:block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="float: left; margin-right: 20px;">
                    <label id="lblPublico" class="infraLabelObrigatorio">Formato: <img
                                src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                                name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipFormato, 'Ajuda') ?>
                                alt="Ajuda" class="infraImg"/></label><br/>
                    <input type="radio" class="infraRadio" name="formatoDocumentoPrincipal" value="nato" id="rdNato1_1"
                           onclick="selecionarFormatoNatoDigitalPrincipal()"/>
                    <label for="rdNato1_1" class="infraLabelRadio">Nato-digital</label>
                    <input type="radio" class="infraRadio" name="formatoDocumentoPrincipal" value="digitalizado"
                           id="rdDigitalizado1_2" onclick="selecionarFormatoDigitalizadoPrincipal()"/>
                ...
                <div id="camposDigitalizadoPrincipal" style="float: left; width: 55%; display: none;">
                    <div style="float: left; width: 100%;">
                        ...
                        <select class="infraSelect" id="TipoConferenciaPrincipal" name="TipoConferenciaPrincipal"
                                width="285" style="width: 285px; float:left; margin-right: 5px;">
                            <option value=""></option>
...
<form method="post" id="frmDocumentosEssenciais" enctype="multipart/form-data"
      action="<?= $strLinkUploadDocEssencial ?>">

    <input type="hidden" id="hdnDocEssencial" name="hdnDocEssencial" value="<?= $_POST['hdnDocEssencial'] ?>"/>
    <input type="hidden" id="hdnDocEssencialInicial" name="hdnDocEssencialInicial"
           value="<?= $_POST['hdnDocEssencialInicial'] ?>"/>
    ...
    <div style="float: left; height: 42px;">
        <label id="lblPublico" class="infraLabelObrigatorio">Tipo de Documento: <img
                    src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                    name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipTipoDocumento, 'Ajuda') ?> alt="Ajuda"
                    class="infraImg"/></label>
        <br/>

        <select class="infraSelect" style="width: 200px; margin-right: 10px;" name="tipoDocumentoEssencial"
                id="tipoDocumentoEssencial">
            <option value=""></option>
            <?
    ...
    <div style="float: left; height: 42px;">
        <label id="lblPublico" class="infraLabelObrigatorio">Complemento do Tipo de Documento: <img
                    ...
                    alt="Ajuda" class="infraImg"/></label>
        <br/>
        <input type="text" class="infraText" name="complementoEssencial" id="complementoEssencial" style="width: 240px;"
               maxlength="40"/>
    </div>
    ...
    <div style="float: left;">
        <? if ($isUsuarioExternoPodeIndicarNivelAcesso == 'S') { ?>
            <label id="lblPublico" class="infraLabelObrigatorio">Nível de Acesso: <img
                        ...
                        name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipNivelAcesso, 'Ajuda') ?>
                        alt="Ajuda" class="infraImg"/></label> <br/>
            <select class="infraSelect" id="nivelAcesso2" name="nivelAcesso2"
                    onchange="selectNivelAcesso('nivelAcesso2', 'hipoteseLegal2')"
                    style="width: 120px; margin-right: 10px;">
                <?= $strItensSelNivelAcesso ?>
            </select>
        <? } else { ?>
    ...
    <div id="divhipoteseLegal2" style="float: left; width: 70%; display:block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div id="divhipoteseLegal2" style="float: left; width: 70%; display:none;">
            ...
            <? if ($isConfigHipoteseLegal && $isNivelAcessoPadrao != 'S') { ?>
                ...
                <select class="infraSelect" id="hipoteseLegal2" name="hipoteseLegal2"
                        style="width: 95%; float: left; margin-right: 5px;">
                    <option value=""></option>
                    <?
                    if ($isConfigHipoteseLegal && is_array($arrHipoteseLegal) && count($arrHipoteseLegal) > 0) {
        ...
        <div style="float: left; margin-right: 20px;">
            <label id="lblPublico" class="infraLabelObrigatorio">Formato: <img
                        src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg"
                        name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipFormato, 'Ajuda') ?> alt="Ajuda"
                        class="infraImg"/></label><br/>
            <input type="radio" class="infraRadio" name="formatoDocumentoEssencial" value="nato" id="rdNato2_1"
                   onclick="selecionarFormatoNatoDigitalEssencial()"/>
            <label for="rdNato2_1" class="infraLabelRadio">Nato-digital</label>
            <input type="radio" class="infraRadio" name="formatoDocumentoEssencial" value="digitalizado"
                   id="rdDigitalizado2_2" onclick="selecionarFormatoDigitalizadoEssencial()"/>
...
<form method="post" id="frmDocumentosComplementares" enctype="multipart/form-data"
      action="<?= $strLinkUploadDocComplementar ?>">

    <input type="hidden" id="hdnDocComplementar" name="hdnDocComplementar" value="<?= $_POST['hdnDocComplementar'] ?>"/>
    <input type="hidden" id="hdnDocComplementarInicial" name="hdnDocComplementarInicial"
           value="<?= $_POST['hdnDocComplementarInicial'] ?>"/>
    ...
    <div style="float: left; height: 42px;">
        ...
        <select class="infraSelect" style="width: 200px; margin-right: 10px;" name="tipoDocumentoComplementar"
                id="tipoDocumentoComplementar">
            <option value=""></option>
            <?
    ...
    <div style="float: left; height: 42px;">
        <label id="lblPublico" class="infraLabelObrigatorio">Complemento do Tipo de Documento: <img
                    ...
                    alt="Ajuda" class="infraImg"/></label>
        <br/>
        <input type="text" class="infraText" name="complementoComplementar" id="complementoComplementar"
               style="width: 240px;" maxlength="40"/>
    </div>
    ...
    <div style="float: left;">
        <? if ($isUsuarioExternoPodeIndicarNivelAcesso == 'S') { ?>
            <label id="lblPublico" class="infraLabelObrigatorio">Nível de Acesso: <img
                        ...
                        name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipNivelAcesso, 'Ajuda') ?>
                        alt="Ajuda" class="infraImg"/></label> <br/>
            <select class="infraSelect" id="nivelAcesso3" name="nivelAcesso3"
                    onchange="selectNivelAcesso('nivelAcesso3', 'hipoteseLegal3')"
                    style="width: 120px; margin-right: 10px;">
                <?= $strItensSelNivelAcesso ?>
            </select>
        <? } else { ?>
    ...
    <div id="divhipoteseLegal3" style="float: left; width: 70%; display:block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div id="divhipoteseLegal3" style="float: left; width: 70%; display:none;">
            ...
            <? if ($isConfigHipoteseLegal && $isNivelAcessoPadrao != 'S') { ?>
                ...
                <select class="infraSelect" id="hipoteseLegal3" name="hipoteseLegal3"
                        style="width: 95%; float: left; margin-right: 5px;">
                    <option value=""></option>
                    <?
                    if ($isConfigHipoteseLegal && is_array($arrHipoteseLegal) && count($arrHipoteseLegal) > 0) {
        ...
        <div style="float: left; margin-right: 20px;">
            <label id="lblPublico" class="infraLabelObrigatorio">Formato: <img
                        ...
                        name="ajuda" <?= PaginaSEI::montarTitleTooltip($strMsgTooltipFormato, 'Ajuda') ?> alt="Ajuda"
                        class="infraImg"/></label><br/>
            <input class="infraRadio" type="radio" name="formatoDocumentoComplementar" value="nato" id="rdNato3_1"
                   onclick="selecionarFormatoNatoDigitalComplementar()"/>
            <label for="rdNato3_1" class="infraLabelRadio">Nato-digital</label>
            <input class="infraRadio" type="radio" name="formatoDocumentoComplementar" value="digitalizado"
                   id="rdDigitalizado3_2" onclick="selecionarFormatoDigitalizadoComplementar()"/>
        ...
        <div id="camposDigitalizadoComplementar" style="float: left; width: 55%; display: none;">
            <div style="float: left; width: 100%;">
                <label class="infraLabelObrigatorio">Conferência com o documento digitalizado:</label> <br/>
                <select class="infraSelect" id="TipoConferenciaComplementar" name="TipoConferenciaComplementar"
                        width="285" style="width: 285px; float:left; margin-right: 5px;">
                    <option value=""></option>
                    <? foreach ($arrTipoConferencia as $tipoConferencia) {
                        echo "<option value=' " . $tipoConferencia->getNumIdTipoConferencia() . "'>";
