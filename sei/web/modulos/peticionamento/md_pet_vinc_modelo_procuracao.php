...
<label>
    <ul>
        <li><p class="Texto_Justificado" style="margin: 0">Poderá, a qualquer tempo, por meio do SEI-@sigla_orgao@, revogar a Procuração Eletrônica Especial;</p></li>
        <li><p class="Texto_Justificado" style="margin: 0">O Outorgado poderá, a qualquer tempo, por meio do SEI-@sigla_orgao@, renunciar a Procuração Eletrônica Especial;</p></li>
