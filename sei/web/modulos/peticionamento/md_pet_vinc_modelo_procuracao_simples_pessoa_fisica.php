<div>
    <table align="center" style="font: bold 12pt Calibri, sans-serif; text-align: justify; word-wrap: normal; text-indent: 0; width: 90%;" border=0>
        <tbody>
        <tr>
            <td style="padding-left: 15px; width: 220px">Pessoa Física Outorgante:</td>
        ...
        <tr>
            <td style="padding-left: 15px;" style="vertical-align:top;">Poderes:</td>
            <td style="font-weight: normal;"> @tpPoderes </td>
        </tr>
        <tr>
            <td style="padding-left: 15px;">Validade:</td>
...
<p style="font: normal 12pt Calibri, sans-serif; text-align: justify; word-wrap: normal; text-indent: 0; margin: 6pt;">A existência e validade desta Procuração Eletrônica Simples pode ser conferida no Portal na Internet do(a) @descricao_orgao@.</p>
