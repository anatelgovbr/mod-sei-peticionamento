...
<p class="Texto_Justificado">Pela presente Renúncia de Procuração Eletrônica, o Outorgado abaixo indicado renunciou aos poderes recebidos do Outorgante por meio da Procuração Eletrônica referenciada.</p>
...
<div>
    ...
    <tbody>
        ...
        <tr class="trEspaco">
            <td>Procuração Eletrônica:</td>
        </tr>
        <tr>
            <td style="font-weight: normal;" class="tdTabulacao">Número do Processo</td>
...
<p class="Texto_Justificado">A existência deste instrumento de Renúncia de Procuração Eletrônica, do processo e dos documentos acima indicados pode ser conferida no Portal na Internet do(a) @descricao_orgao@.</p>