    ...
    <form id="frmEdicaoAuxiliar"
      ...
      ?>
        ...
        <fieldset  style="min-width:400px; width:70%">
            ...
            <p id="txtInformativo1">Informe abaixo o CPF do Usuário Externo que deseja indicar como novo Responsável Legal por esta Pessoa Jurídica.</p>
        </fieldset> 
        <br/><br/>
        ...
        <label id="lblRazaoSocial" class="infraLabelObrigatorio" style="display: inline-block; min-width:120px;  width: 60%">Razão Social:<br/>
            ...
            <label class="infraLabelObrigatorio" style="display: inline-block;  min-width:180px;  width: 16.5%">CPF do Usuário Externo:<br/>
