...
?>
<fieldset id="fieldDocumentos" class="infraFieldset form-control sizeFieldset" <?php echo !$stAlterar ? 'style="display: none; width: auto;"' : 'style="width: auto;"' ?>>
    ...
    <form method="post" id="frmDocumentoAto" enctype="multipart/form-data" action="<?= $strLinkUploadArquivo ?>">
        ...
        <div class="p-3 mb-2 subFieldset">
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-2">
                        <label class="labelDocumentoArea"><strong>Documento</strong></label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-5 col-lg-4 col-xl-3">
                    <div class="form-group mb-3">
                        ...
                        <select id="selTipoDocumento" class="infraSelect form-select" <?php echo $disabledConsultar ?> tabindex="<?php echo PaginaSEIExterna::getInstance()->getProxTabDados(); ?>">
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-8 col-xl-9">
                        <div id="divBlcHipoteseLegal" <?= !isset($arrHipoteseNivel['hipoteseLegal']) ? 'style="display: none;"' : '' ?>>
                            <div class="form-group mb-3">
                                ...
                                <?php else: ?>
                                    <select id="selHipoteseLegal" class="infraSelect form-select unclear"  tabindex="<?= PaginaSEIExterna::getInstance()->getProxTabDados() ?>" disabled>
                    ...
                    <div class="form-group mb-3">
                        <div id="divTipoConferencia" style="display: none;">
                            ...
                            <div class="input-group">
                                <select id="selTipoConferencia" name="selTipoConferencia" class="infraSelect form-select mr-1" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados(); ?>">
            ...
            <div class="row">
                <div class="col-12">
                    <div id="divArquivo" class="form-group infraAreaDados mb-1">
                        <label class="infraLabelObrigatorio" for="fileArquivo">
                            Tamanho máximo do arquivo: <?php echo is_int($tamanhoMaximo) ? $tamanhoMaximo . 'Mb' : $tamanhoMaximo; ?><br>
                ...
                <div class="col-12">
                    <div id="divTipoConferenciaBotao">
                        <button type="button" accesskey="A" class="infraButton mt-2" id="btnAdicionarDocumentoBotao" onclick="adicionarDocumento();" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados(); ?>">
