...
class MdPetEmailNotificacaoRN extends InfraRN { 
	...
	protected function notificaoPeticionamentoExternoConectado($arrParams ){
		...
		$objEmailSistemaDTO->setStrIdEmailSistemaModulo( self::$EMAIL_PETICIONAMENTO_USUARIO_PETICIONANTE );
		...
		if ($objEmailSistemaDTO!=null){
	     ...
	     $objEmailSistemaDTO->retStrAssunto();
	     $objEmailSistemaDTO->retStrConteudo();
	     $objEmailSistemaDTO->setStrIdEmailSistemaModulo( self::$EMAIL_PETICIONAMENTO_UNIDADE_ABERTURA );
