...
//        echo "<pre>";
        ...
        if ($isReciboDoc) {
            ...
            $imgRecibo = '<img src="modulos/peticionamento/imagens/svg/intimacao_recibo_peticionamento_resposta.svg?'.PeticionamentoIntegracao::$ICONS_VERSION.'" style="width: 24px">';
