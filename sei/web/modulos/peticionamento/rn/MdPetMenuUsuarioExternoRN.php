...
class MdPetMenuUsuarioExternoRN extends InfraRN {
	...
	protected function desativarControlado($arrMdPetMenuUsuarioExternoDTO) {
		...
		try {
			...
			SessaoSEI::getInstance ()->validarAuditarPermissao('md_pet_menu_usu_ext_desativar', __METHOD__, $arrMdPetMenuUsuarioExternoDTO);
	...
	protected function reativarControlado($arrMdPetMenuUsuarioExternoDTO) {
		...
		try {
			...
			SessaoSEI::getInstance ()->validarAuditarPermissao('md_pet_menu_usu_ext_reativar', __METHOD__, $arrMdPetMenuUsuarioExternoDTO);
	...
	protected function excluirControlado($arrMdPetMenuUsuarioExternoDTO) {
		...
		try {
			...
			SessaoSEI::getInstance ()->validarAuditarPermissao('md_pet_menu_usu_ext_excluir', __METHOD__, $arrMdPetMenuUsuarioExternoDTO);
	...
	protected function cadastrarControlado(MdPetMenuUsuarioExternoDTO $objMdPetMenuUsuarioExternoDTO) {
		try {
			// Valida Permissao
			SessaoSEI::getInstance ()->validarAuditarPermissao ('md_pet_menu_usu_ext_cadastrar', __METHOD__, $objMdPetMenuUsuarioExternoDTO );
	...
	protected function alterarControlado(MdPetMenuUsuarioExternoDTO $objMdPetMenuUsuarioExternoDTO) {
		try {
			// Valida Permissao
			SessaoSEI::getInstance ()->validarAuditarPermissao ('md_pet_menu_usu_ext_alterar', __METHOD__, $objMdPetMenuUsuarioExternoDTO );
