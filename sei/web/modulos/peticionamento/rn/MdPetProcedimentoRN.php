...
class MdPetProcedimentoRN extends ProcedimentoRN {
  ...
  //alteracoes seiv3
  //metodo foi removido, esta й uma versao migrada do seiv2
  //inicio
  protected function lancarAcessoControleInternoControlado(ProcedimentoDTO $objProcedimentoDTO){
    try{
      ...
      if ($objProcedimentoDTO->getStrStaNivelAcessoGlobalProtocolo()!=ProtocoloRN::$NA_SIGILOSO){
        ...
        //seiv2
        //$objControleInternoDTO->setNumIdTipoProcedimentoRelControleInternoTipoProc($objProcedimentoDTO->getNumIdTipoProcedimento());
        //alteracoes seiv3
      ...
      throw new InfraException('Erro lanзando acesso para o Controle Interno.',$e);
    }
  }
  //fim
