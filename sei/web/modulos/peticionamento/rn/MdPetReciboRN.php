...
class MdPetReciboRN extends InfraRN
{
    ...
    private function gerarHTMLConteudoDocRecibo($arrParams)
    {
        ...
        if( PeticionamentoIntegracao::verificaSeModIAVersaoMinima() && PeticionamentoIntegracao::permitirClassificacaoODSUsuarioExterno()){
            ...
            $arrIdMetasSelecionadas = $arrParams['metas_ods_onu'];
    ...
    protected function excluirControlado(MdPetReciboDTO $objDTO)
    {
        ...
        try {
            ...
            throw new InfraException ('Erro excluindo Recibo Peticionamento, ', $e);
        }
    }
