...
class MdPetCriterioRN extends InfraRN
{
    ...
    protected function listarConectado(MdPetCriterioDTO $objMdPetCriterioDTO)
    {
        ...
        try {
            ...
            SessaoSEI::getInstance()->validarAuditarPermissao('criterio_intercorrente_peticionamento_listar', __METHOD__, $objMdPetCriterioDTO);
    ...
    protected function consultarConectado(MdPetCriterioDTO $objMdPetCriterioDTO)
    {
        ...
        try {
            ...
            SessaoSEI::getInstance()->validarAuditarPermissao('criterio_intercorrente_peticionamento_consultar', __METHOD__, $objMdPetCriterioDTO);
    ...
    protected function alterarControlado(MdPetCriterioDTO $objMdPetCriterioDTO)
    {
        ...
        try {
            ...
            // Valida Permissao
            SessaoSEI::getInstance()->validarAuditarPermissao('criterio_intercorrente_peticionamento_alterar', __METHOD__, $objMdPetCriterioDTO);
    ...
    protected function cadastrarControlado(MdPetCriterioDTO $objMdPetCriterioDTO)
    {
        ...
        try {
            // Valida Permissao
            SessaoSEI::getInstance()->validarAuditarPermissao('criterio_intercorrente_peticionamento_cadastrar', __METHOD__, $objMdPetCriterioDTO);
    ...
    protected function desativarControlado($arrMdPetCriterioDTO)
    {
        ...
        try {
            SessaoSEI::getInstance()->validarAuditarPermissao('criterio_intercorrente_peticionamento_desativar', __METHOD__, $arrMdPetCriterioDTO);
            $objMdPetCriterioBD = new MdPetCriterioBD($this->getObjInfraIBanco());
    ...
    protected function excluirControlado($arrMdPetCriterioDTO)
    {
        ...
        try {
            ...
            SessaoSEI::getInstance()->validarAuditarPermissao('criterio_intercorrente_peticionamento_excluir', __METHOD__, $arrMdPetCriterioDTO);
            $objMdPetCriterioBD = new MdPetCriterioBD($this->getObjInfraIBanco());
            for($i = 0; $i < count($arrMdPetCriterioDTO); $i ++) {
