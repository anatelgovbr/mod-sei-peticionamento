...
/**
	...
	protected function alterarControlado(MdPetIndisponibilidadeDTO $objMdPetIndisponibilidadeDTO){
		try {
			...
			// Valida Permissao
			SessaoSEI::getInstance()->validarAuditarPermissao ('indisponibilidade_peticionamento_alterar', __METHOD__, $objMdPetIndisponibilidadeDTO);
	...
	protected function cadastrarControlado(MdPetIndisponibilidadeDTO $objMdPetIndisponibilidadeDTO) {
		try {
			// Valida Permissao
			SessaoSEI::getInstance ()->validarAuditarPermissao ('indisponibilidade_peticionamento_cadastrar', __METHOD__, $objMdPetIndisponibilidadeDTO );
	...
	private function _controlarAnexos(MdPetIndisponibilidadeDTO $objMdPetIndisponibilidadeDTO){
		...
		protected function desativarControlado($arrMdPetIndisponibilidadeDTO) {
			...
			try {
				...
				SessaoSEI::getInstance ()->validarAuditarPermissao('indisponibilidade_peticionamento_desativar', __METHOD__ ,$arrMdPetIndisponibilidadeDTO);
		...
		protected function reativarControlado($arrMdPetIndisponibilidadeDTO) {
			...
			try {
				...
				SessaoSEI::getInstance ()->validarAuditarPermissao('indisponibilidade_peticionamento_reativar', __METHOD__,$arrMdPetIndisponibilidadeDTO);
		...
		protected function excluirControlado($arrMdPetIndisponibilidadeDTO) {
			...
			try {
				...
				SessaoSEI::getInstance ()->validarAuditarPermissao('indisponibilidade_peticionamento_excluir', __METHOD__,$arrMdPetIndisponibilidadeDTO);
