...
/**
	...
	protected function desativarControlado($arrMdPetTipoProcessoDTO) {
		...
		try {
			...
			SessaoSEI::getInstance ()->validarAuditarPermissao('tipo_processo_peticionamento_desativar', __METHOD__, $arrMdPetTipoProcessoDTO);
	...
	protected function reativarControlado($arrMdPetTipoProcessoDTO) {
		...
		try {
			...
			SessaoSEI::getInstance ()->validarAuditarPermissao('tipo_processo_peticionamento_reativar', __METHOD__, $arrMdPetTipoProcessoDTO);
	...
	protected function excluirControlado($arrMdPetTipoProcessoDTO) {
		...
		try {
			...
			SessaoSEI::getInstance ()->validarAuditarPermissao('tipo_processo_peticionamento_excluir', __METHOD__, $arrMdPetTipoProcessoDTO);
	...
	protected function cadastrarControlado(MdPetTipoProcessoDTO $objMdPetTipoProcessoDTO) {
		try {
			// Valida Permissao
			SessaoSEI::getInstance ()->validarAuditarPermissao ('tipo_processo_peticionamento_cadastrar', __METHOD__, $objMdPetTipoProcessoDTO );
	...
	protected function alterarControlado(MdPetTipoProcessoDTO $objMdPetTipoProcessoDTO) {
		try {
			// Valida Permissao
			SessaoSEI::getInstance ()->validarAuditarPermissao ('tipo_processo_peticionamento_alterar', __METHOD__, $objMdPetTipoProcessoDTO );
