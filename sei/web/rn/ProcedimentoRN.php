  ...
  protected function verificarLiberacaoNumeroProcessoConectado(ProcedimentoDTO $objProcedimentoDTO){
    try{
      ...
      if ($objProcedimentoDTO->getDblIdProcedimento()==null){
        ...
        if (($numHabilitarNumeroProcessoInformado == 1 && $strSinUnidadeProtocolo == 'S')
             || $numHabilitarNumeroProcessoInformado == 2
             || $numHabilitarNumeroProcessoInformado == 3){
          return true;
        }

      }else{

        if ((($numHabilitarNumeroProcessoInformado == 1 || $numHabilitarNumeroProcessoInformado == 3) && $strSinUnidadeProtocolo=='S')
            || $numHabilitarNumeroProcessoInformado == 2) {
